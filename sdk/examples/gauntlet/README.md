...
Fog follows every player: seven tiles completely clear, then a three-tile soft edge. Nearby sight combines across all sixteen players, including fallen allies. Rooms become hidden again when everyone moves away; the minimap and full-dungeon camera respect this. Walls and closed doors block sight, including diagonal corners. Opening a door reveals the passage beyond; nearby room contents remain hidden until someone can see them. Menus remain unobscured; no controls are required to reveal the area around you.
