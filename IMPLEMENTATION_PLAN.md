...
- [ ] Local creator preview: documented semantic actions, reusable lobby/menu/lifecycle, independent 2D starter, structured TV/controller checks beyond `doctor --project`.
