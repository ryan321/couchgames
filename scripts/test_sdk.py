...
def main():
    ...
    for arguments, expected in [
        ...
        (["--headless", "--path", str(root / "sdk"), "--script", "res://tests/test_lobby.gd"], "SDK lobby checks passed:"),
        ...
        (["--headless", "--path", str(root / "sdk"), "--script", "res://tests/test_flat_world.gd"], "Flat World checks passed:"),
        ...
        (["--headless", "--path", str(root / "sdk"), "--script", "res://tests/test_haymaker.gd"], "Haymaker checks passed:"),
