...
fn route(
    ...
    match (method, path) {
        ...
        (Method::Get, "/landing-worlds/jet.png") => Ok(png_response(pages::WORLD_JET_PNG)),
        (Method::Get, "/landing-worlds/car.png") => Ok(png_response(pages::WORLD_CAR_PNG)),
        (Method::Get, "/landing-worlds/wizard.png") => Ok(png_response(pages::WORLD_WIZARD_PNG)),
